...
import { ScenarioRunner } from "@/scenario/components/ScenarioRunner";

export const Route = createFileRoute("/session/$id/scenario")({
...
function RouteComponent() {
  ...
  return <ScenarioRunner session={data.session} bot={data.bot} />;
}
