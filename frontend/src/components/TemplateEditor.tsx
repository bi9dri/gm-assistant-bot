...
const TemplateEditorContent = ({ nodes, edges, viewport, mode = "edit" }: Props) => {
  ...
  const handleAddNode = useCallback(() => {
    ...
    if (selectedNodeType === "AddRoleToRoleMembers" || selectedNodeType === "CreateCategory" || selectedNodeType === "CreateChannel" || selectedNodeType === "CreateRole" || selectedNodeType === "DeleteCategory" || selectedNodeType === "DeleteRole") {
