...
- [scenario-editor-architecture.md](docs/dev/scenario-editor-architecture.md) — **required reading before any issue #213 sub-issue work** (scenario-document UI; pins the 22 confirmed decisions). New features go here, not into the older UIs.
